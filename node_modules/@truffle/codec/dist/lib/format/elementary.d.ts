 ...
 */
export declare type ElementaryValue = UintValue | IntValue | BoolValue | BytesValue | AddressValue | StringValue | FixedValue | UfixedValue | EnumValue | UserDefinedValueTypeValue | ContractValue;
export declare type BuiltInValueValue = UintValue | IntValue | BoolValue | BytesStaticValue | AddressValue | FixedValue | UfixedValue;
/**
 * A bytestring value (static or dynamic)
 *
 * @Category Elementary types
 */
export declare type BytesValue = BytesStaticValue | BytesDynamicValue;
/**
 ...
 * @Category Elementary types
 */
export declare type StringValueInfo = StringValueInfoValid | StringValueInfoMalformed;
/**
 ...
 * @Category User-defined elementary types
 */
export declare type ContractValueInfo = ContractValueInfoKnown | ContractValueInfoUnknown;
/**
