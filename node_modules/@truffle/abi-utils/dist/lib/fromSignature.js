...
exports.parseParameterListWithRemainder = exports.parseParameterList = exports.parseSignature = exports.eventFromSignature = exports.errorFromSignature = exports.functionFromSignature = void 0;
function functionFromSignature(signature) {
...
exports.functionFromSignature = functionFromSignature;
function errorFromSignature(signature) {
    const { name, inputs } = parseSignature(signature);
    return {
        type: "error",
        name,
...
exports.errorFromSignature = errorFromSignature;
...
exports.eventFromSignature = eventFromSignature;
...
function parseParameterListWithRemainder(parameterList) {
    ...
    while (true) {
        if (remaining[0] === "(") {
            ...
            let components;
            ({ parameters: components, remaining } = parseParameterListWithRemainder(remaining));
            ...
            if (final) { //if we hit a ")", close this group
...
exports.parseParameterListWithRemainder = parseParameterListWithRemainder;
//# sourceMappingURL=fromSignature.js.map